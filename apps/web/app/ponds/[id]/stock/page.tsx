...
export default function StockPage() {
  ...
  async function submit(event: FormEvent) {
    ...
    if (!rate) {
      ...
      window.setTimeout(() => document.getElementById('stock-rate')?.focus(), 0);
      return;
    }
    try {
