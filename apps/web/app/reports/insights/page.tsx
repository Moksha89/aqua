...
function moneyFigure(value: string) { return { value: `₹${(Number(value ?? 0) / 100).toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`, unit: '', status: 'DETERMINED' }; }
