...
function moneyFigure(value?: string) { return value ? { value: formatPaise(value), unit: '', status: 'DETERMINED' } : { value: '', unit: '₹', status: 'NOT_DETERMINABLE', reason: 'Frozen value is not available.' }; }
