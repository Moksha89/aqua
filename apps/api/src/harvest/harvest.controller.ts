...
export class HarvestController {
  ...
  close(@Param('id') id: string, @Req() r: AuthenticatedRequest): Promise<CloseCropResponseDto> { return this.harvests.close(id, this.ctx(r)) as Promise<CloseCropResponseDto>; }
